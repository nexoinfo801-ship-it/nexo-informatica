'use strict';
const CACHE_NAME='nexa-mobile-r10-26-shell-v1';
const ASSETS=['./','./index.html','./style.css','./manual-search.js','./gateway.js','./app.js','./manifest.webmanifest','./manuals.json','./assets/nexa-icon.svg'];
